...
class GestoreCliente(Cliente):
    ...
    def creaCliente(self,nome, cognome, idCliente,indirizzo,telefono,email,datNascita):
        self.setCliente(nome,cognome,idCliente,indirizzo,telefono,email,datNascita)
